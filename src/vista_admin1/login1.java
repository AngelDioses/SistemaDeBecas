...
public class login1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_usuario.setFont(txt_usuario.getFont().deriveFont(txt_usuario.getFont().getSize()+2f));
        txt_usuario.setForeground(new java.awt.Color(255, 255, 255));
        txt_usuario.setBorder(null);
        jPanel2.add(txt_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(39, 140, 240, 30));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        boolean esValido = usuarioDAO.validarUsuario(usuario, password, 
                "SELECT * FROM usuarios WHERE username = ? AND password = ?");
        if (esValido) {
            ControlPostulantes1 control = new ControlPostulantes1();
            control.setVisible(true);
            login1.this.dispose();
        } else {
            // Si las credenciales son incorrectas, muestra un mensaje de error
            JOptionPane.showMessageDialog(this, "Usuario o contraseña incorrectos", "Error de inicio de sesión", JOptionPane.ERROR_MESSAGE);
            // Limpia los campos para que el usuario pueda intentarlo de nuevo
            txt_usuario.setText("");
