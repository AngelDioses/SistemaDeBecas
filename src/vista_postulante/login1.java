...
public class login1 extends javax.swing.JFrame {
    ...
    public boolean iniciarSesion(String usuario, String password) {
        //Guardamos las variables de los campos y verificamos si es valido el usuario
        ...
        boolean esValido = usuarioDAO.validarUsuario(usuario, password,
                "SELECT * FROM usuariosEstudiantes WHERE correo = ? AND contrasena = ?");
        /*
        Si es valido, entonces se creara un usuario en el que, a traves de la clase SesionUsuario(Singleton-Acceso Global),
        se podra acceder en todos los paneles
        */
        if (esValido) { 
            usuarioActual = usuarioDAO.obtenerUsuarioPorCredenciales(usuario, password);
            usuarioActual.setCorreo(usuario);
            usuarioActual.setContraseña(password);
            SesionUsuario.getInstancia().setUsuarioLogueado(usuarioActual);
            PanelEst control = new PanelEst(); //Creamos un objeto del panel de estudiante y lo mostramos
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Login - Estudiantes");
        ...
        jPanel2.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 360, 122, -1));

        jLabel14.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(199, 226, 255));
        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel14.setText("¿Eres Nuevo? ");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        iniciarSesion(txt_usuario.getText(), txt_password.getText());
